package com.study.boardAPI.controller;

import com.study.boardAPI.Service.BoardService;
...
public class BoardController {
    ...
    // 인수가 많아지면 힘들어짐 => 따라서 Board라는 Entity를 만들어서 관리를 용이하게 만들자!
    // 클래스에서 사용하려면 @Data(lombok)을 사용해야한다!
